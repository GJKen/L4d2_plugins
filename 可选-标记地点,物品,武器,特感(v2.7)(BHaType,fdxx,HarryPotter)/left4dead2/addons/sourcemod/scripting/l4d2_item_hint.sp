...
public void OnPluginStart()
{
	...
	g_hSpotMarkAnnounceType		= CreateConVar("l4d2_spot_marker_announce_type", "0", "标记提示的显示方式 (0: 禁用, 1: 在聊天中, 2: 在提示框中, 3: 在屏幕中心)", FCVAR_NOTIFY, true, 0.0, true, 3.0);
...
void CreateStringMap()
{
	...
	g_smModelToName.SetString("models/w_models/weapons/w_autoshot_m4super.mdl", "M1014");
	...
	g_smModelToName.SetString("models/infected/hunter_l4d1.mdl", "Hunter!来空爆");
	g_smModelToName.SetString("models/infected/witch.mdl", "有妹快摸她奶子!");
	g_smModelToName.SetString("models/infected/witch_bride.mdl", "有妹快摸她奶子!");
	g_smModelToName.SetString("models/infected/spitter.mdl", "Spitter!");
	g_smModelToName.SetString("models/infected/jockey.mdl", "Jockey!");
	g_smModelToName.SetString("models/infected/charger.mdl", "Charger,快冲!");
